...
function updateCustomizableColor(color) {
  ...
  const carTitles = document.querySelectorAll(".carousel-title");
  console.log("Found car titles:", carTitles.length);
  for (let y = 0; y < carTitles.length; y++) {
    carTitles[y].style.color = color;
    carTitles[y].style.borderColor = color;
  }
